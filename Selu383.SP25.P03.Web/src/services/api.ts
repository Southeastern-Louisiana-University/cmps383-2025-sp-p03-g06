...
export const theaterApi = {
  ...
  getTheaterById: async (id: number): Promise<TheaterDTO> => {
    ...
    if (!response.ok) {
      console.error(`Failed to fetch theater with id ${id}, status:`, response.status);
  ...
  createTheater: async (theater: Omit<TheaterDTO, 'id'>): Promise<TheaterDTO> => {
  ...
  updateTheater: async (id: number, theater: Omit<TheaterDTO, 'id'>): Promise<TheaterDTO> => {
    ...
    if (!response.ok) {
      console.error(`Failed to update theater with id ${id}, status:`, response.status);
  ...
  deleteTheater: async (id: number): Promise<void> => {
    ...
    if (!response.ok) {
      console.error(`Failed to delete theater with id ${id}, status:`, response.status);

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TheaterRooms_Theaters_TheaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConcessionItems_ConcessionCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TheaterRoomId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConcessionOrders_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_ConcessionOrders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConcessionItems_CategoryId",
                table: "ConcessionItems",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ConcessionOrders_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Showtimes_TheaterRoomId",
                table: "Showtimes",
                column: "TheaterRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_TheaterRooms_TheaterId",
                table: "TheaterRooms",
                column: "TheaterId");
        }
